...
public class UserTests2 {
	...
	public void createUser() {
		...
		Response createUser = UserEndpoints2.createUser(pojo);
...
//		System.out.println(un);
	...
	public void getUser() {
		...
		Response user = UserEndpoints2.getUser(this.pojo.getUsername());
...
//		System.out.println(user.jsonPath().getString("username"));
	...
	public void updateUser() {
		...
		Response updateUser = UserEndpoints2.updateUser(pojo, this.pojo.getUsername());
...
//		System.out.println(user.asPrettyString());
	...
	public void deleteUser() {
		...
		Response user = UserEndpoints2.deleteUser(this.pojo.getUsername());
//		System.out.println(user.asPrettyString());
//		System.out.println(user.jsonPath().getString("username"));
		Assert.assertEquals(user.statusCode(), 200);
